...
Exp2=$(curl -sS https://raw.githubusercontent.com/ryankputra/instalasi/main/register | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/ryankputra/instalasi/main/register"
...
function check_and_update() {
    ...
    if [ "$latest_commit" != "$last_commit" ]; then
        ...
        if [[ "$update_choice" == "Y" || "$update_choice" == "y" ]]; then
            ...
            wget -q https://raw.githubusercontent.com/RyyStore/autoscriptVIP/main/m-update.sh -O m-update.sh
            chmod +x m-update.sh
            ./m-update.sh
...
cd
rm -rf *
wget https://raw.githubusercontent.com/RyyStore/autoscriptVIP/main/m-update.sh
clear
